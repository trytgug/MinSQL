...
def parse_option():
    ...
    parser.add_argument("--input_dataset_path", type=str, default='../generate_datasets/preprocessed_data.json')
    parser.add_argument("--self_consistent", type=bool, default=True)
    parser.add_argument("--n", type=int, default=1,
                        help="Size of self-consistent set")
    parser.add_argument("--output_recalled_tables_path", default='../generate_datasets/table_recall.json', type=str)
...
1 - Find the related tables for generating SQL queries for each question based on the database schema according to the question order. 
